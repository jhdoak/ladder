...
export 'package:ladder_api/ladder_api.dart';
export 'package:aqueduct/test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for ladder_api.
///
/// Use instances of this class to start/stop the test ladder_api server. Use [client] to execute
/// requests against the test server.  This instance will use configuration values
/// from config.src.yaml.
class TestApplication {
  Application<LadderApiSink> application;
  ...
  Future start() async {
    ...
    application = new Application<LadderApiSink>();
